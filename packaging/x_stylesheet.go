...
// XColors Colors type
type XColors struct {
	IndexedColors []interface{} `xml:"x:indexedColors"` // Color Indexes
	MruColors     []interface{} `xml:"x:mruColors"`     // MRU Colors
}
...
type XFormat struct {
	...
	//ExtLst []interface{} `xml:"extLst"` // Future Feature Data Storage Area
	//PivotArea []interface{} `xml:"pivotArea"` // Pivot Area
}
